...
4. `git push origin dayYYYYMMDD` — push your branch. user reviews and merges to main.
...
2. **Plan:** Write a brief plan (what files to create/edit, what commands to run, acceptance criteria).
3. **Exec:** Implement the plan.
4. **Eval:** Check against acceptance criteria. If issues found, go back to Analyze (max 3 loops).
5. **Done:** Mark task [x] in BACKLOG.md, remove it, append to today's day file.

## Important
- Work in /path/to/your/hermes-agent-blueprint\
- Never commit secrets or .env files.
- Update BACKLOG.md and today's day file after every task completion.
